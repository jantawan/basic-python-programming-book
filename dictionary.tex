...
การหาค่าของคีย์ในดิกชันนารีเมื่อรู้ value เช่น สร้างฟังก์ชัน \pyinline{reverse_lookup()} มีการส่ง Parameters สองตัวคือ Dictionary กับ Value สำหรับ Key แต่ละตัวใน Dictionary นี้ ถ้า ค่าของ Dictionary เท่ากับ Value ที่ต้องการ ให้ส่งค่า Key กลับมา แต่ถ้าไม่มีก็จะไม่ต้องส่งอะไรออกมา ดังตัวอย่างต่อไปนี้
...
\item จงดำเนินการต่อไปนี้
	\begin{itemize}
		\item สร้าง dictionary ชื่อ stock มีค่าคือ \\
			\pyinline{'banana': 40, 'apple': 10, 'orange': 15, 'pear': 33}
		\item สร้าง dictionary ชื่อ prices มีค่าคือ \\
			\pyinline{'banana': 4, 'apple': 2, 'orange: 1.5, 'pear': 3}
...
มีค่าคือ \pyinline{{1: 10, 2: 20, 3: 30, 4: 40, 5: 50, 6: 60}}
