...
การตั้งชื่อตัวแปรมีเงื่อนไขดังนี้  \cite{lutz2014}
...
สิ่งที่อยู่ในหน่วยความจำมีประเภทของข้อมูลหรือ Type อยู่ด้วย โดยใช้คำสั่ง \pyinline{type()} เพื่อดูประเภทของข้อมูล ในภาษา Python มีประเภทของข้อมูลหลายๆ แบบ \cite{Luc15}
...
ดังตัวอย่างที่แสดงในรูปที่ \ref{figure:typeofdata} ในหน้า \pageref{figure:typeofdata}

\begin{figure}[h!]
\label{figure:typeofdata}
\caption{ประเภทของข้อมูล}
\begin{pycode}
>>> a = 1
>>> a
1
...
\begin{figure}[h!]
\caption{ตัวอย่างคำนวณทางคณิตศาสตร์}
\begin{pycode}
>>> a
1
>>> b
...
\begin{figure}[h]
\caption{ การจัดการข้อความด้วยเครื่องหมายทางคณิตศาสตร์}
\begin{pycode}
>>> firstname
'Jantawan'
>>> lastname
...
\begin{figure}[h!]
\caption{การใช้ Comment ในบรรทัดเดียว}
\begin{pycode}
>>> print('Hello world!')
|Hello world!|
...
\begin{figure}[h!]
\caption{การใช้ Comment ในหลายบรรทัด}
\begin{pycode}
>>> x = '''
hello
1
...
\begin{figure}[h!]
\caption{ตัวอย่าง Python source code}
\begin{pycode}
x = 7
y = 6
...
\begin{figure}[h!]
\caption{ตัวอย่างผลลัพธ์ที่ได้จากการประมวลผล Source code}
\begin{pycode}
>>>
|x is greater than y.|
>>>
